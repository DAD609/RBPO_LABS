...
#include <iostream>
#include <new>
export module dynamic_structure: StackBasedOnUnidirectionalLinkedList;
using namespace std;
...
export namespace dynamic_structure
    {
        template <typename T>
        class StackBasedOnUnidirectionalLinkedList : public AbstractClass<T> {
            template <typename T>
            class Node {
            public:
                T data;
        ...
        public:
            ...
            StackBasedOnUnidirectionalLinkedList<T>& operator=(initializer_list<T> ilist);
        ...
        template<typename T>
        StackBasedOnUnidirectionalLinkedList<T>& StackBasedOnUnidirectionalLinkedList<T>::operator=(initializer_list<T> ilist) {
            clear(); 
